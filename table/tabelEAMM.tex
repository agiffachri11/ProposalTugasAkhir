...
Sudah ada TRM dan \textit{standards profile}. Selain itu, \textit{gap analysis} dan rencana migrasi diterapkan untuk semua \textit{domain} arsitektur. &
...
Dokumentasi arsitektur diperbarui secara rutin dan semua \textit{domain} mengikuti standar yang sama. &
