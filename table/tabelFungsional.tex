...
KF-03 &
Parameter \textit{Impact} Level &
Proses harus menyediakan parameter objektif dalam menentukan kategori \textit{high impact} atau \textit{minimum impact}. \\

KF-04 &
Konsultasi Formal dengan \textit{Enterprise Architect} &
Inisiatif bernilai \textit{high impact} harus melalui sesi konsultasi formal dengan \textit{Enterprise Architect} sebelum diteruskan ke tahap berikutnya. \\
...
Proses harus menyediakan fitur pencatatan revisi, histori perubahan, dan jejak audit untuk setiap penyuntingan. \\
