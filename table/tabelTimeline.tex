...
Minggu 4-6 &
Perancangan mekanisme \textit{EA Impact Analysis} \textit{To-Be} meliputi alur proses, peran, \textit{input} dan \textit{output}, serta elemen analisis per \textit{domain}. &
Rancangan mekanisme \textit{EA Impact Analysis To-Be}. \\

Minggu 7-9 &
Penyusunan \textit{template} analisis per \textit{domain} sesuai TOGAF. &
